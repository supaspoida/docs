...
export const meta = {
  ...
  lastEdited: '2019-05-02T16:20:42.000Z'
}
...
The key part here is line 3, for those used to working with Express, it should be similar to accessing `req.body`.

The `json(req)` function returns the request body in the JSON format, fully parsed and ready to work with.
