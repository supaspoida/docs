...
export const meta = {
  ...
  lastEdited: '2019-05-07T00:46:45.000Z'
}
...
The endpoint contains the code shown in [step 1](#step-1:-setting-up-the-function) deployed using a [`now.json` file](/docs/v2/deployments/configuration/). You will receive a response like the following:
