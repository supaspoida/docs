...
To illustrate the parsing of the request body, let's take the simple function below as an example:
...
This function takes a POST request, parses the body and uses it in the response.
