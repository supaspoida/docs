...
import AddonsDocs from './addons-docs-mdx/index.mdx'
  ...
  render() {
    ...
    return (
      ...
      >
        <Layout>
          <Head
            description="A comprehensive guide to creating and using the Now Addons API and gaining control over the Now platform"
            title={`Now Addons Documentation`}
            titlePrefix=""
            titleSuffix=" - ZEIT"
          />

          <DocsBuilder docs={<AddonsDocs />}>
            {({ structure }) => (
              <Main>
                <Sidebar
...
export default withRouter(AddonsPage)
